...
const categories = [
  ...
  {amount: 14, name: 'MSB Rooms', icon: 'bolt-lightning'},
  {amount: 5, name: 'Hoisting', icon: 'person-arrow-up-from-line'},
  ...
  {amount: 2, name: 'Others', icon: 'gears'},
];
